...
/obj/machinery/suit_cycler
	...
	var/list/species = list("Human","Skrell","Unathi","Tajara", "Vulpkanin","Resomi")
...
/obj/machinery/suit_cycler/engineering
	...
	species = list("Human","Tajara", "Vulpkanin","Skrell","Unathi","Resomi") //Add Unathi when sprites exist for their suits.
...
/obj/machinery/suit_cycler/mining
	...
	species = list("Human","Tajara", "Vulpkanin","Skrell","Unathi","Resomi")
