...
/obj/machinery/suit_cycler/engineering
	...
	species = list("Human","Vulpkanin","Tajara","Skrell","Unathi","Resomi") //Add Unathi when sprites exist for their suits.
...
/obj/machinery/suit_cycler/mining
	...
	species = list("Human","Vulpkanin","Tajara","Skrell","Unathi","Resomi")
